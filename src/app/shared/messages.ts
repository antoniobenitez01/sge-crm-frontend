...
export const ENTIDAD_ALUMNO = "Alumno";                       //  AÑADIDO : Alumno
export const ENTIDAD_VACANTE = "Vacante";                     //  AÑADIDO : Vacante
export const ENTIDAD_VACANTEXALUMNO = "Vacante X Alumno";     //  AÑADIDO : Vacante X Alumno
